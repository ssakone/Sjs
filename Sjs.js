...
var default_ressource = [
	{
		name: "jquery", 
		module_name: "jquery.min", 
		version: "3.6.0", 
		type: "js",
		offline_path: "/static/assets/"},
	{
		name: "sweetalert", 
		module_name: "sweetalert.min", 
		version: "2.0.0", 
		type: "js"
		offline_path: "/static/assets/"}]
...
class Ressource {
	...
	offlineProviders: []
	selectedOnlineProviders: "cloudflare"
	selectedOfflineProviders: ""
	fetchMethod: ""


	loadAll() {
		switch(this.fetchMethod) {
			case RESSOURCE_FETCH_METHOD.ONLINE:
				loadFromOnline()
		}
	}
	...
	loadFromOnline() {
		return new Promise((resolve, reject) => {
			let provider_url = this.onlineProviders[this.selectedOnlineProviders]
	...
	loadFromOnlineProvider() {

	}

	loadFromOfflineProvider() {

	}
}


class Sjs extends Ressource {
	constructor() {}
}
